[![Build Status](https://travis-ci.org/limon05111998/js-assignments.svg?branch=master)](https://travis-ci.org/limon05111998/js-assignments)
![Hackage-Deps](https://img.shields.io/hackage-deps/v/lens.svg)
[![Greenkeeper badge](https://badges.greenkeeper.io/limon05111998/js-assignments.svg)](https://greenkeeper.io/)
[![GitHub release](https://img.shields.io/github/release/limon05111998/js-assignments.svg)](https://github.com/limon05111998/js-assignments/releases/latest)
...
* Edit local README.md file and update all links (just replace all occurrences of `'limon05111998'` with your account name).
...
```
* Open https://github.com/limon05111998/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/limon05111998/js-assignments/builds).
